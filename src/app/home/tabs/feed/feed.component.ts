...
import { IonContent, IonRefresher, IonRefresherContent, IonSpinner, IonList, IonItem, IonSelect, IonSelectOption, IonPopover, IonButton, IonIcon } from '@ionic/angular/standalone';
...
@Component({
	...
	imports: [IonSpinner, LocationRiddlePostComponent, IonRefresherContent, IonRefresher, IonContent, IonList, IonItem, IonSelect, IonSelectOption, FormsModule, IonPopover, IonButton, IonIcon],
